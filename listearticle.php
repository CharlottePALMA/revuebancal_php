...
if(!isset($_GET['page'])){
    redirect('listearticle.php?page=1');
}
...
$bancal = $db->prepare('SELECT * FROM article LEFT JOIN categories ON article.category_id = categories.id_categorie ORDER BY article.created DESC LIMIT :p, :n');
