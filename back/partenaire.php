    ...
    <div class="fond-noir-partenaire">  
        <div class="fond-partenaire">
            <div class="wrapper row no-padding">
                <div class="marg-1 col-10 haut-partenaire">
        ...
        <div class="wrapper">
            <section class="formulaire-partenaire">
                <div class="contour">
                    ...
                    <p>
                        <button class="button"><a href="form_partenariat.php">accéder au formulaire</a></button>
                    </p>
                </div>
            </section>
        </div>
