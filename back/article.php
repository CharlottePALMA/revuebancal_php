...
<body>
    ...
    <div class="fond-pattern">
       <div class="wrapper article-image">
           ...
           <div class="marg-1 col-10">
               <div class="infos-partenaire">
               <h1><?php echo $data['titre'] ?></h1>
               <p class="article-auteur">Auteur - <?php echo $dataAuteur['prenom'] ?> <?php echo $dataAuteur['nom'] ?></p>
        ...
        <div class="wrapper row">
            <section class="marg-1 col-7">
                ...
                <div class="informations-complementaires">
                    <ul class="partage">
                        ...
                        <li><a href="" target="_blank" class="mail gauche">Mail</a></li>                
                ...
                <div class="commentaires">
                    <h1 class="titre-page titre-danspage">Commentaires</h1>
                    <hr class="half-rule">
                    <?php 
                ...
                ?>
                        <article class="bloc-article col-6">
                                ...
                                <figure><img src="data/article/en_avant/<?= $dataArticle2['image_avant'] ?>" alt=""/></figure>
                                <div class="contenu-article">
            ...
            <section class="col-3 bloc-droite">
