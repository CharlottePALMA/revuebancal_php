...
if(empty($_POST['s'])){
    ...
    $nbElement = $db->prepare('SELECT * FROM partenaire WHERE name LIKE :t OR editeur_partenaire LIKE :t');
    $recherche = '%'.$_POST['s'].'%'; 
...
if(empty($_POST['s'])){
    ...
    SELECT * 
    FROM partenaire 
    WHERE name LIKE :t OR editeur_partenaire LIKE :t
...
<div class="wrapper">
    ...
    <form action="page_liste_partenaire.php" method="post">
        <section class="entete-page">
            <div class="row">
                <h1 class="titre-page">Liste des partenaires</h1>
                <a href="nouveau_partenaire.php" class="button-page">Nouveau partenaire</a>
            </div>
        </section>
            ...
            <div class="wrapper">
                <div class="row">
                    <div class="input-group">
                        <input type="text" name="s" placeholder="rechercher un partenaire" <?php 
                        ...
                        <table class="table-box">
                            ...
                            <?php 
			                 ...
			                 while($data = $bancal->fetch(PDO::FETCH_ASSOC)){ ?>
			                     <tr>
				                    <td><a href="updatePartenaire.php?id=<?= $data['id'] ?>">
					                   <?= $data['name']; ?>
					               </a></td>
					               ...
					               <td><?php
                                    ...
                                    <td><a href="partenaire.php?id=<?= $data['id'] ?>">Aperçu</a></td>
                                    <td><a href="../core/deletePartenaire.php?id=<?= $data['id'] ?>">Supprimer</a></td>
				                </tr>
                            <?php } ?>
                        </table>
                    </div>
        ...
        if($nbPage>1){?>
            <div class="pagination pagination-centrer">
                <?php if($_GET['page'] != 1){?>
                <a href="page_liste_partenaire.php?page=1"><img src="../img/fleche-gauche-02-gris.png" alt="première page" ></a>
                <a href="page_liste_partenaire.php?page=<?php
                    $page = $_GET['page'];
                    $page = $page - 1;
                    echo $page;
                ...
                <?php } 
                for($i=1; $i <= $nbPage; $i++){?>
                    <a href="page_liste_partenaire.php?page=<?= $i ?>"
                ...
                <a href="page_liste_partenaire.php?page=<?= $nbPage ?>"><img src="../img/fleche-droite-02-gris.png" alt="dernière page" ></a>
                <?php } ?>
            </div>
            <?php } ?>
        </form>
