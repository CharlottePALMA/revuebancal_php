...
if(empty($_POST['s'])){
    $nbElement = $db->prepare('SELECT * FROM content');
}else{
    $nbElement = $db->prepare('SELECT * FROM content WHERE page LIKE :t');
    $recherche = '%'.$_POST['s'].'%'; 
...
<body>
    ...
    <div class="wrapper">
        ...
        <form action="page_liste_content.php" method="post">
            <section class="entete-page">
                <div class="row">
                    <h1 class="titre-page">Liste contenu</h1>
                    <a href="nouveau_content.php" class="button-page">Nouveau contenu</a>
                </div>
            </section>
                ...
                <div class="wrapper">
                    <div class="row">
                        <div class="input-group">
                                ...
                                <input name="s" type="text" placeholder="rechercher un contenu" <?php 
                        ...
                        <div class= "col-10 marg-1">
                            <table class="table-box">
                                ...
                                while($data = $bancal->fetch(PDO::FETCH_ASSOC)){ ?>
                                    <tr>
                                        <td><a href="updateContent.php?id=<?= $data['id'] ?>">
                                            <?= $data['page']; ?>
                                        </a></td>
                                        <td><a href="../core/deleteContent.php?id=<?= $data['id'] ?>">Supprimer</a></td>
                                    </tr>
                                <?php } ?>
                            </table>
                        </div>
            ...
            <div class="pagination pagination-centrer">
                <?php if($_GET['page'] != 1){?>
                <a href="page_liste_content.php?page=1"><img src="../img/fleche-gauche-02-gris.png" alt="première page" ></a>
                <a href="page_liste_content.php?page=<?php
                    $page = $_GET['page'];
                    $page = $page - 1;
                    echo $page;
                ...
                <?php } 
                for($i=1; $i <= $nbPage; $i++){?>
                    <a href="page_liste_content.php?page=<?= $i ?>"
                ...
                <a href="page_liste_content.php?page=<?= $nbPage ?>"><img src="../img/fleche-droite-02-gris.png" alt="dernière page" ></a>
                <?php } ?>
            </div>
            <?php } ?>
        </form>
